    ...
    copy: {
      main: {
        files: [
          ...
          {src: ['bower_components/MathJax/**'], dest: 'dist/',expand:true},
          {src: ['tools/textAngularResources/**'], dest: 'dist/',expand:true},
          {src: ['tools/math_jax_accessibility/**'], dest: 'dist/',expand:true}
